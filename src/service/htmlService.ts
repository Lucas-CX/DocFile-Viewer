...
export class HtmlService {
    ...
    public static previewHtml(uri: vscode.Uri, context: vscode.ExtensionContext) {
        ...
        const webviewPanel = vscode.window.createWebviewPanel("docfile.viewHtml", basename(uri.fsPath), { viewColumn: vscode.ViewColumn.Two, preserveFocus: true }, { enableScripts: true })
