...
- Fix markdown image paste in custom editor
  Use the active DocFile markdown document for paste handling so image pastes create files reliably and stop rewriting the clipboard, which avoids interfering with Cursor chat image paste.
